...
const genderBox = document.getElementById("gender") as HTMLSelectElement;
const sortBox = document.getElementById("sort") as HTMLSelectElement;
const rowsBox = document.getElementById("rowsPerPage") as HTMLSelectElement;

let rowsToShow: number = 10;

function showTable(): void {
  tbody.innerHTML = "";

  let result: Student[] = students.slice();
  ...
  if (genderBox.value === "M" || genderBox.value === "F") {
    const selectedGender = genderBox.value as "M" | "F";
    const temp: Student[] = [];
